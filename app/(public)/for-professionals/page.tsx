...
export const metadata: Metadata = {
    title: 'For Professionals — TopDek',
    description: 'List your services on TopDek for free, accept walk-ins or call-outs, and get discovered by clients ready to book.',
